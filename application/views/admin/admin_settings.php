                ...
                <div id="Shorts_key" class="sub_box">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" class="Button2 Button13 WhiteButton" name="submit" id="settings_submit" value="Save settings" onclick="return validateSettings(<?php echo $result['id'] ? $result['id'] : 0; ?>)"/></td>
...
<script type="text/javascript">
    function validateSettings(id)
    {
        ...
        var encryption_key          = $('input#encryption_key ').val();
        var admin_email             = $('input#admin_email ').val();
        var need_invite             = $('input:radio[name=need_invite]:checked').val();
        var facebook_app_id         = $('input#facebook_app_id ').val();
        var facebook_app_key        = $('input#facebook_app_key ').val();
        var facebook_app_secret     = $('input#facebook_app_secret ').val();
        var tweet_consumer_key      = $('input#tweet_consumer_key ').val();
        var tweet_consumer_secret   = $('input#tweet_consumer_secret ').val();
        ...
        val ='id='+id+'&base_url='+base_url+'&encryption_key='+encryption_key+'&admin_email='+admin_email+'&need_invite='+need_invite+'&facebook_app_id='+facebook_app_id+'&facebook_app_key='+facebook_app_key+'&facebook_app_secret='+facebook_app_secret+'&tweet_consumer_key='+tweet_consumer_key+'&tweet_consumer_secret='+tweet_consumer_secret;
