...
/**
Auth controller to handle authentication purposes

* @package pinterest clone controller
* @subpackage
* @uses : To handle  authentication purposes
* @version $id:$
* @since 22-05-2012
...
class Auth extends CI_Controller
{
	 ...
	 * @return void
	 */
	function logout($noentry=false,$messgae=false)
	{
       
        $noentryMessage = $this->session->userdata('noentry_message');
