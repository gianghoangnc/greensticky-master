...
INSERT INTO `activity` (`id`, `user_id`, `log`, `type`, `action_id`, `link`, `timestamp`) VALUES
...
INSERT INTO `comments` (`id`, `user_id`, `pin_id`, `comments`) VALUES
...
INSERT INTO `follow` (`id`, `user_id`, `is_following`, `is_following_board_id`) VALUES
(1131, 166, 165, 167),
(1132, 167, 166, 168),
(1133, 166, 167, 169),
(1134, 167, 166, 174);
...
INSERT INTO `likes` (`pin_id`, `source_user_id`, `like_user_id`) VALUES
(365, 165, 166),
(371, 166, 167),
(375, 167, 166),
(383, 168, 168);
